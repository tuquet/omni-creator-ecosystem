-- ============================================================================
-- MODULE 2: SUBSCRIPTIONS, ENTITLEMENTS & QUOTA METERING
-- Description: SaaS Tiers, Quota Enforcement (max projects, max members), & Usage Tracking.
-- Usage: Execute in Supabase SQL Editor or append to migrations when subscription or quota limits are needed.
-- ============================================================================
...
CREATE OR REPLACE TRIGGER update_tenant_subscriptions_modtime
...
CREATE OR REPLACE TRIGGER trigger_auto_assign_free_subscription
...
CREATE OR REPLACE TRIGGER trigger_enforce_project_quota
