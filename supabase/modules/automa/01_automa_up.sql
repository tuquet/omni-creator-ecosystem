-- ============================================================================
-- MODULE: AUTOMA CLOUD BRIDGE (UP MIGRATION)
-- Version: 20260924000005
-- Scope: Multi-tenant schemas, RLS, and permissions for Tuquet Automa.
-- Target: Supabase / PostgreSQL (public schema)
-- Tables: automa_workflows, automa_runners, automa_campaign_runs,
--         automa_execution_logs, automa_schedules
-- ============================================================================
...
-- Outbox Trigger for Campaign Lifecycle Events
...
-- ----------------------------------------------------------------------------
-- 5. RBAC PERMISSIONS & ROLE MAPPINGS
-- ----------------------------------------------------------------------------
